...
#ifndef H_EOCH_SCRIPT
#define H_EOCH_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CEOCHAddress
 */
...
public:
    ...
    // Pre-version-0.6, EOCH always counted CHECKMULTISIGs
