...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // EOCH is not connected
...
extern json_spirit::Value regstaticnode(const json_spirit::Array& params, bool fHelp);
